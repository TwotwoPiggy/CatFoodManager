...
namespace CatFoodManager.Core.Models
{
    /// <summary>
    /// 猫粮实体，表示猫粮产品的详细信息。
    /// Cat food entity, representing detailed information of cat food products.
    /// </summary>
    public class CatFood : BaseEntity
    {
        ...
        /// <summary>
        /// 品牌名称（从关联实体获取）。
        /// Brand name (obtained from associated entity).
        /// </summary>
        [Ignore]
