...
/// <summary>
/// 最低价格实体，记录产品的历史最低价格信息。
/// Best price entity, recording historical lowest price information for products.
/// </summary>
public class BestPrice : BaseEntity
{
    /// <summary>
    /// 产品类型（猫粮、零食等）。
    /// Product type (cat food, snack, etc.).
    /// </summary>
    public ProductType Type { get; set; }

    /// <summary>
    /// 购买平台（京东、淘宝等）。
    /// Purchase platform (JD, Taobao, etc.).
    /// </summary>
