...
/// <summary>
/// 图片任务处理器，处理图片删除和移动任务�?/// Image task handler, handling image delete and move tasks.
/// </summary>
public class ImageTaskHandler : ITaskHandler
{
    ...
    /// <summary>
    /// 图片参数类�?    /// Image parameters class.
    /// </summary>
    private class ImageParameters
    {
        /// <summary>
        /// 操作类型（delete/move）�?        /// Action type (delete/move).
        /// </summary>
        ...
        /// <summary>
        /// 目标路径（移动操作时使用）�?        /// Destination path (used for move action).
        /// </summary>
