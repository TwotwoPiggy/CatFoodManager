...
/// <summary>
/// 代工厂服务类，提供代工厂相关的业务操作�?/// Factory service class, providing factory-related business operations.
/// </summary>
public class FactoryService : IFactoryService
{
    ...
    /// <summary>
    /// 更新代工厂�?    /// Updates a factory.
    /// </summary>
    /// <param name="entity">要更新的代工厂实�?/ Factory entity to update</param>
    /// <param name="cancellationToken">取消令牌 / Cancellation token</param>
