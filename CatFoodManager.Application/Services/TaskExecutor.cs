...
/// <summary>
/// 任务执行器类，提供任务执行和管理功能�?/// Task executor class, providing task execution and management functionality.
/// </summary>
public class TaskExecutor : ITaskExecutor
{
    ...
    /// <summary>
    /// 执行指定任务�?    /// Executes the specified task.
    /// </summary>
    ...
    /// <summary>
    /// 检查任务是否正在运行�?    /// Checks if a task is running.
    /// </summary>
    /// <param name="taskId">任务ID / Task ID</param>
    /// <param name="cancellationToken">取消令牌 / Cancellation token</param>
    ...
    /// <summary>
    /// 终止指定任务�?    /// Terminates the specified task.
    /// </summary>
    /// <param name="taskId">任务ID / Task ID</param>
    /// <param name="cancellationToken">取消令牌 / Cancellation token</param>
    ...
    /// <summary>
    /// 获取正在运行的任务数量�?    /// Gets the count of running tasks.
    /// </summary>
    /// <param name="cancellationToken">取消令牌 / Cancellation token</param>
    /// <returns>正在运行的任务数�?/ Count of running tasks</returns>
